...
#define COMMAND_READ_CH0 0Xb4 //Address the Ch0 lower data register and configure for Read Word
#define COMMAND_READ_CH1 0Xb6 //Address the Ch1 lower data register and configure for Read Word
//ADDRESS
#define CONTROL   	0x00
#define TIMING    	0x01
